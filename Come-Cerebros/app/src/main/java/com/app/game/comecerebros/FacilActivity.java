...
public class FacilActivity extends AppCompatActivity implements OnClickListener {
    ...
    private void Cargar() {
        ...
        numB = numeroB.nextInt(10);
        numC = numeroC.nextInt(10);
        numD = numeroD.nextInt(10);
        ...
        switch (v.getId()) {
            ...
            case R.id.botonVolver_F:
                ...
                if (musica != null) {
                    ...
                    musica_S.start();
                    Intent intento_V = new Intent(FacilActivity.this, JugarActivity.class);
            ...
            case R.id.botonValidar:
                ...
                if (simbolos == 0) {
                    r1 = (numB + numD);
                    Cargar(r1, r2);
                    resultados.add(numB + "+" + numD + "=" + r2 + "," + B_M + "\n");
                }
                //RESTA:
                else if (simbolos == 1) {
                    r1 = (numB - numD);
                ...
                //MULTIPLICACIÓN:
                    ...
                    r1 = (numB * numD);
                    Cargar(r1, r2);
                    resultados.add(numB + "x" + numD + "=" + r2 + "," + B_M + "\n");
                }
                //DIVISIÓN:
                else if (simbolos == 3) {
                    if (numD == 0) {
